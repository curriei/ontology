...
import ontologysynonyms_5_20.Canonical;
import ontologysynonyms_5_20.EquivalenceListOfList;
import ontologysynonyms_5_20.OFDSynonyms_5_20;

import java.util.Queue;
import java.util.Set;
import java.util.Stack;

public class OFDSynonyms_11_1000 {
	...
	public static void setExcessThree(boolean isExcessThree) {
		OFDSynonyms_11_1000.isExcessThree = isExcessThree;
	}

	public static void main(String[] args) throws SQLException {

		EquivalenceListOfList_11_1000 eq1 = new EquivalenceListOfList_11_1000();
		eqmap = eq1.getEquiList();

		Canonical_11_1000 c1 = new Canonical_11_1000();
