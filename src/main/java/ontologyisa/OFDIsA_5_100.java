...
public class OFDIsA_5_100 {
	...
	public static void setExcessThree(boolean isExcessThree) {
		OFDIsA_5_100.isExcessThree = isExcessThree;
	}
	...
	public static void main(String[] args) throws SQLException, IOException {
		...
		writer = new PrintWriter("isa_5_100", "UTF-8");

		processList(iteqmap, itcmap);
		
		writer.close();
		
		stripDuplicatesFromFile("isa_5_100");
		//System.out.println();
		
		System.out.println("contents of file are: ");
		System.out.println();
		
		BufferedReader br = new BufferedReader(new FileReader("isa_5_100"));
		 String line = null;
	...
	private static boolean compareGreaterLength(Object[] array, String ckey) {
		...
		if (compare.size() == 0)
			...
			boolean value = isa.isWithinThreshold(lca, medicineList);
			return value;
		} else if (ckey == "minage") {
			String first = compare.get(0);
			for (String element : compare) {
